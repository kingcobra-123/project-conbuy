...
const CreatePostRender = ({uploadStatus, onClose, isVisible, closeUploadModal}) => {
                    ...
                    <Animated.View style={{ transform: [{ translateY: iconY }] }}>
                            {uploadStatus === 'success' ? (
                                <View style= {{alignItems: 'center'}}>
                                    ...
                                    <AntDesign style = {{alignSelf:'center', paddingTop:8}}name="checkcircle" size={24} color="green" />
                                 </View>
                            ) : uploadStatus === 'failed' ? (
                                <View style={{justifyContent:'center', flexDirection: 'column'}}>
                                    <Text style={{fontSize:12, paddingTop:10, alignSelf:'center'}}>Failed Creating Your Review...</Text>
                         ...
                         <View style = {styles.separator}></View>
                            <TouchableOpacity onPress={()=>handlePress()}>
                                <Text style={{fontWeight:'600', color: '#F7A70B', paddingBottom:30}}>Cancel</Text>
                            </TouchableOpacity>
                        </View>
                </View>
        </Modal>
