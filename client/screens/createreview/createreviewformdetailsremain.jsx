...
const CreateReviewFormDetailsRemain = ({ formData, onChange }) => {
  ...
  const [selectedOtherSubCategory, setSelectedOtherSubCategory] =
    useState(null);
  ...
  const categoryDropdownOptions = [
    { title: "Sofa & Couch", icon: "couch", label: "sofaAndCouch" },
    { title: "Tv", icon: "tv", label: "tv" },
    { title: "Mattress", icon: "bed", label: "mattress" },
    { title: "Other", icon: "plus-circle", label: "other" },
  ];

  const recommendationDropdownOptions = [
    { title: "Buy", icon: "thumbs-up", label: true },
    { title: "Do not Buy", icon: "thumbs-down", label: false },
  ];
  ...
  const subCategoryDropdownOptions = {
    ...
    Other: [{ title: "Other", icon: "plus-circle" }],
  };
      ...
      <View style={styles.reviewCategory}>
        ...
        <SelectDropdown
          ...
          onSelect={(selectedItem, index) => {
            ...
            onChange("category", selectedItem.label);
            ...
            return (
              <View style={styles.dropdownButtonStyle}>
                {selectedItem && (
                  <Icon
                    name={
                      selectedItem ? selectedCategory.icon : "globe-americas"
                    }
                ...
                <Icon
                  name={isOpened ? "chevron-up" : "chevron-right"}
        ...
        {selectedCategory && (
          <SelectDropdown
            ...
            onSelect={(selectedItem, index) => {
              ...
              onChange("subCategory", selectedItem.title);
              if (selectedItem.title === "Other") {
      ...
      {selectedOtherSubCategory && (
        <View style={styles.textInputContainer}>
          <TextInput
            ...
            placeholderTextColor={"grey"}
            style={styles.textInputStyles}
            onChangeText={(text) => onChange("subCategory", text)}
          />
        </View>
      )}
      ...
      <View style={styles.reviewCategory}>
        ...
        <SelectDropdown
          ...
          onSelect={(selectedItem, index) => {
            ...
            onChange("buyOrNotBuy", selectedItem.label);
          }}
          renderButton={(selectedItem, isOpened) => {
            return (
              <View style={styles.dropdownButtonStyle}>
                {selectedItem && (
                  <Icon
                    name={
                      selectedItem ? selectedBuyOrNotBuy.icon : "globe-americas"
                    }
                    style={styles.dropdownButtonIconStyle}
                  />
                )}
      ...
      {selectedPurchaseURL && (
        <View style={styles.textInputContainer}>
          <TextInput
            ...
            placeholderTextColor={"grey"}
            style={styles.textInputStyles}
            onChangeText={(text) => onChange("purchaseLink", text)}
          />
        </View>
      )}
      <View style={styles.reviewCategory}>
