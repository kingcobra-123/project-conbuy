  ...
  return (
    <View style={styles.header}>
      <ScrollView horizontal showsHorizontalScrollIndicator="false">
        <Chip
          key="filter"
          icon={() => <Ionicons name="filter-sharp" size={20} color="black" />}
          onPress={(key) => {
            handlePress("filter");
          }}
          mode="outlined"
          ...
          style={[
            {
              backgroundColor:
                selectedfilter === "filter" ? "#F7A70B" : "white",
            },
          ]}
          elevated="true"
        >
        ...
        <Chip
          ...
          onPress={(key) => {
            handlePress("sofaAndCouch");
          }}
          style={[
            {
              backgroundColor:
                selectedfilter === "Sofa and Couch" ? "#fff4b8" : "white",
            },
          ]}
        >
          Sofa & Couch
        ...
        <Chip
          ...
          onPress={(key) => {
            handlePress("mattress");
          }}
          style={[
            {
              backgroundColor:
                selectedfilter === "Mattress" ? "#fff4b8" : "white",
            },
          ]}
        >
          Mattress
        ...
        <Chip
          ...
          style={[
            { backgroundColor: selectedfilter === "TV" ? "#F7A70B" : "white" },
          ]}
        >
          TV's
        </Chip>
        <Chip
          ...
          style={[
            {
              backgroundColor:
                selectedfilter === "others" ? "#F7A70B" : "white",
            },
          ]}
        >
          Others
